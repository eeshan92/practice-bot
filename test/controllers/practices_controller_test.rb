...
class PracticesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create practice" do
    assert_difference('Practice.count') do
      post practices_url, params: { practice: { date: @practice.date, end: @practice.end, location: @practice.location, start: @practice.start, status: @practice.status } }
    end
  ...
  test "should update practice" do
    patch practice_url(@practice), params: { practice: { date: @practice.date, end: @practice.end, location: @practice.location, start: @practice.start, status: @practice.status } }
